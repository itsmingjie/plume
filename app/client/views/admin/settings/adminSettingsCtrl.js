angular.module('reg')
  .controller('AdminSettingsCtrl', [
    ...
    function ($scope, $sce, SettingsService) {
      ...
      $scope.updateIsDayOf = function () {
        SettingsService
          .updateIsDayOf($scope.settings.isDayOf)
          .success(function (data) {
            $scope.settings.isDayOf = data.isDayOf;
            const successText = $scope.settings.isDayOf ?
              "Day-of controls has been turned on." :
              "Day-of controls has been turned off."
            swal({
                title: "Looks good!",
                text: successText,
                type: "success"
